...
public class BenTest {
	...
	public void create() {
            ...
            Calendar cal = new GregorianCalendar(2017,03,11,8,30);
            c.setMedecin(m);
            c.setDebut(cal.getTime());
            cal.set(2017, 03, 11, 9, 00);
        ...
        /**
         * Test creation of a deletion when rdv
         */
	@Test
	public void extraDeletion() {
            WebTarget target = client.target(URL);
            Rdv created = null;
            ...
            if (response.getStatus() != 200) {
                ...
                created = response.readEntity(Rdv.class);
                id = created.getId();
            }
            if(created!=null) {
